...
struct unrollPartialProds{
	__host__ __device__ static void __forceinline__ unrollX_trunc(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
	...
	__host__ __device__ static void __forceinline__ unrollX_all(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
	...
	__host__ __device__ static void __forceinline__ unrollY(const int exp_start, const int LBN, const double x, const int exp_x, const double *y, const int *exp_y, double *B){
		double p, e;
	...
	__host__ __device__ static void __forceinline__ unroll_simple1(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
		double p;
	...
	__host__ __device__ static void __forceinline__ unroll_simple2(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
		double p;
...
// Multiplication_accurate without truncation of the partial products
// with relative error <= 2^{-(p-1)R}( 1 + (r+1)2^{-p} )
template <int K, int L, int R>
__host__ __device__ static __forceinline__ void certifiedMul(const double *x, const double *y, double *r){
...
//template <int K, int L, int R>
//__host__ __device__ static __forceinline__ void truncatedMul(const double *x, const double *y, double *r){
//	int const LBN = R*dbl_prec/binSize + 2;
//  double B[LBN+2], lim[LBN+2];
//  int i;
//
...
//template <int K, int L, int R>
//__host__ __device__ static __forceinline__ void baileyMul_fast(double const *x, double const *y, double *z){
//  double p, e, f[R+1];
//  int i, j, n = R;
...
//template <int K, int L, int R>
//__host__ __device__ static __forceinline__ void baileyMul_renorm(double const *x, double const *y, double *z){
//  double p, e, f[R+1];
//  int i, j, n = R;
//  for(i=K+L-1; i<R; i++) f[i] = 0.0;
//
